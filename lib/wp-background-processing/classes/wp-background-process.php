<?php
/**
 * WP Background Process (Safe Wrapped)
 *
...
abstract class WP_Background_Process extends WP_Async_Request {
	...
	public function __construct( $allowed_batch_data_classes = true ) {
		...
		// Ensure dispatch query args include extra data.
	...
	protected function handle() {
		...
		$throttle_seconds = max(
			...
			apply_filters(
				...
				apply_filters( $this->prefix . '_seconds_between_batches', 0 )
			)
		);
	 ...
	 *
	 * @deprecated 1.1.0 Superseded. Use cancel().
	 */
